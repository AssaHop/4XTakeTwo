...
export function setupActionFlags(unit) {
  ...
  // ✅ DEBUG: Проверка выставленных флагов
  console.log(`[FLAGS] ${unit.type} →`, {
    canAttackAfterMove: unit.canAttackAfterMove,
    canMoveAfterAttack: unit.canMoveAfterAttack,
    canRepeatAttackOnKill: unit.canRepeatAttackOnKill
  });
}
