...
const ClassTemplates = {
  WDD: { hp: 3, moRange: 3, viRange: 6, atRange: 3, weType: ['Small','Torp'], spawnTerrain: ['surf', 'water', 'deep'], modules: ['Sail'] },
  WCC: { hp: 4, moRange: 3, viRange: 6, atRange: 3, weType: 'Small', spawnTerrain: ['surf', 'water', 'deep'], modules: ['Navy'] },
  ...
  WSS: { hp: 2, moRange: 4, viRange: 6, atRange: 0, weType: null, spawnTerrain: ['surf', 'water', 'deep'] },
